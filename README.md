...
*Not approved or endorsed by Minnesota Fringe,* but I believe Fair Use, and a utility for busy "power users". Only hits their pages when the build script runs, IE nightly, to pick up any changes. Show details link to the official show pages for ticketing, etc.
